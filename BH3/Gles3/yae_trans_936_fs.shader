...
void main()
{
    ...
    u_xlat16_7.x = vs_COLOR0.x * u_xlat10_0.y + vs_COLOR1.x;
    ...
    u_xlat1.xyz = u_xlat1.xyz * u_xlat5.xxx + _WorldSpaceLightPos0.xyz;
    u_xlat5.x = dot(u_xlat1.xyz, u_xlat1.xyz);
    u_xlat5.x = inversesqrt(u_xlat5.x);
    u_xlat1.xyz = u_xlat5.xxx * u_xlat1.xyz;
    u_xlat16_17 = dot(u_xlat16_3.xyz, u_xlat1.xyz);
    ...
    SV_Target0.xyz = u_xlat16_2.xyz * _Color.xyz + u_xlat16_3.xyz;
